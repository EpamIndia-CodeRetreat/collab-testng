...
public abstract class PageWrapper extends Browser{
    ...
    //Need to refactor the below 2 methods to approprite files
    public void ScrollToBottonOfthePage (WebDriver driver){
        JavascriptExecutor jse = (JavascriptExecutor) driver;
        jse.executeScript("window.scrollTo(0, document.body.scrollHeight)");
        Reporter.log(LogLevel.INFO, "Peromed Page Scroll Down ");

    }

    public void actionClick(WebDriver driver){
        Actions action = new Actions(driver);
        action.moveToElement(driver.findElement(By.xpath("//button[@type='submit']/span"))).click().perform();
    }
